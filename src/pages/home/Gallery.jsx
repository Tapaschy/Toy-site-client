    ...
    return (
        <div className='mt-5'>
            ...
            <div className='grid grid-cols-4 gap-4 container mx-auto '>
                ...
                <div className=' rounded-xl bg-primary p-4'>
                <img className='p-3 rounded-md w-full h-full' src="https://i.ibb.co/zmfB79b/m-61e9a35a2e8e44795d95e709.jpg" alt="" />
                </div>
                <div className=' rounded-xl bg-primary p-4'>
                <img className='p-3 rounded-md w-full h-full' src="https://i.ibb.co/80QZhVZ/Disney-Store-Japan-Goofy2020-18.jpg" alt="" />
                </div>
                <div className=' rounded-xl bg-primary p-4'>
                <img className='p-3 rounded-md w-full h-full' src="https://i.ibb.co/wQCC0WW/mickey-and-friends-pull-ring-plastic-toy-donald-duck-in-boat-tricky-rider-tm-p-image-391962-grande.jpg" alt="" />
                </div>
                <div className=' rounded-xl bg-primary p-4'>
                <img className='p-3 rounded-md w-full h-full' src="https://i.ibb.co/mNNNjTH/photo-1528066588405-9e20509b9e34.jpg" alt="" />
                </div>
                <div className=' rounded-xl bg-primary p-4'>
                <img className='p-3 rounded-md w-full h-full' src="https://i.ibb.co/80QZhVZ/Disney-Store-Japan-Goofy2020-18.jpg" alt="" />
                </div>
