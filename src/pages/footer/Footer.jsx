        ...
        <div className=' bg-primary mt-5 '>
            <footer className=" footer  p-10 text-neutral-content container mx-auto items-center">
                ...
                <div className='list-none'>
                    ...
                    <Link to="/alltoys"><li><a className="link link-hover">All Toys</a></li></Link>
                    <Link to="/mytoys"><li><a className="link link-hover">My Toys</a></li></Link>
                    <Link to="/addatoy"><li><a className="link link-hover">Add A Toy</a></li></Link>
                    <Link to=""><li><a className="link link-hover">Blogs</a></li></Link>
                </div>
                <div>
